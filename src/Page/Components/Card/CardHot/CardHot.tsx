          ...
          >
            ...
            >
              <div className="cardHotOverlay">
                {item.isFeatured && (
                  <span className="cardHotHighlight">NỔI BẬT</span>
                )}
                <h3 className="cardHotTitle">{item.title}</h3>
                <p className="cardHotSummary">{item.shortContent}</p>
                <div className="cardHotFooter">
                  <div
                    className="cardHotViews"
                    style={{
